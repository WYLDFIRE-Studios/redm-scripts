...
local buttonTextXOffset = 0.035
local buttonTextYOffset = 0.065
...
local function drawTitle()
	if menus[currentMenu] then
		...
		DrawSprite("inventory_items", "weapon_lasso", 0.17, 0.55, 0.04, 0.06, 2.0, 255, 255, 255, 255, 0)
		DrawSprite("inventory_items", "generic_horse_equip_saddle", 0.25, 0.55, 0.04, 0.06, 2.0, 255, 255, 255, 255, 0)
